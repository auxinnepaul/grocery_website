...
interface ExpandableProps {
  list?: { image: string; title: string; description: string }[];
  autoPlay?: boolean;
  className?: string;
}
...
const items = [
  {
    image:
      "data:image/bmp;base64,",
    title: "Seasonal Fruits",
    description: "Strawberries, blueberries, peaches, apples, etc.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1718027808460-7069cf0ca9ae?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3",
    title: "Seasonal Vegetables",
    description: "Tomatoes, cucumbers, zucchini, corn, etc.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1584968173934-bc0b588eb806?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3",
    title: "Bulk Grains",
    description: "Rice, quinoa, oats, etc.",
  },
  {
    image:
      "https://images.unsplash.com/photo-1584968173934-bc0b588eb806?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3",
    title: "Nuts and Seeds",
    description: "Almonds, walnuts, sunflower seeds, etc.",
  },
];
